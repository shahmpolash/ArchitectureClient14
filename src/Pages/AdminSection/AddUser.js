                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                            ...
                                            {users.map(a =>
                                                <Link className='theme-btn' to={`/admin-user/${a._id}`}> Update User</Link>)}
...

                            {
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleUser}>
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="slider-btn ">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Add User </button>
