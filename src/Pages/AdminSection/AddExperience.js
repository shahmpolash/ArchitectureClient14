                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                    {
                                        exprience.map(a =>
                                            <Link className='theme-btn' to={`/edit-experience/${a._id}`}>
                            ...
                            }
                            {
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleExperienceSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Update Experience </button>
                                        </div>
                                    </div>
