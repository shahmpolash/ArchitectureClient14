                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                                ...
                                <>
                                    {
                                        logo.map(c =>
                                            logo.map(c =>
                                                <Link className='theme-btn' to={`/edit-logo/${c._id}`}> Please Edit Your Logo</Link>)
                            ...
                            }
                            {
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleLogo}>
                                    <div class="row">
                                    ...
                                    <div className="col-lg-12 col-md-12 mb-3">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s">Update Your Logo</button>
                                        </div>
                                    </div>
