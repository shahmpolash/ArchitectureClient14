                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                    {
                                        about.map(a =>
                                            <Link className='theme-btn' to={`/${a._id}`}>
                            ...
                            }
                            {
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleAboutSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Update About </button>
                                        </div>
                                    </div>
