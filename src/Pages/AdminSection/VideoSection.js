                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <h2 className='mb-5 mt-5'> Update Video Section </h2>
                                {
                                    video.length === 1 &&
                                    <> {
                                        video.map(s => <Link className='theme-btn' to={`/videotext-edit/${s._id}`}>Update Video</Link>)
                                    }</>

                                }
                                {
                                    video.length === 0 &&
                                    <form class="contact-form mt-2 " onSubmit={handleVideoSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Update Video Section </button>
                                            </div>
                                        </div>
                                ...
                                <form class="contact-form mt-2" onSubmit={handleAddItem}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Add Team Member </button>
                                        </div>
                                    </div>
