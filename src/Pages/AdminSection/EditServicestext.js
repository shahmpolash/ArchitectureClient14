                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleServiceText}>
                                    <div class="row">
                                        ...
                                        <div className="col-lg-12 col-md-12 mb-3">
                                         ...
                                         <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Update Services Text</button>
                                        </div>
                                    </div>
