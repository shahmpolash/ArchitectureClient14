                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                                ...
                                <>
                                    {
                                        countersec.map(c =>
                                            countersec.map(c=>
                                                <Link className='theme-btn' to={`/counters/${c._id}`}> Update Counter</Link>)
                                        )
                                    }
                                </>
                            }
                            {
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleCounterSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s">Update Counter</button>
                                        </div>
                                    </div>
