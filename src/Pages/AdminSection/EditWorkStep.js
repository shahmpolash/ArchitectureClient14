                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleBannerSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s">Update Work section</button>
                                        </div>
                                    </div>
