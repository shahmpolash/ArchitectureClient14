                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                                ...
                                <>
                                    {
                                        footeraddress.map(c =>
                                            footeraddress.map(c =>
                                                <Link className='theme-btn' to={`/edit-address-footer/${c._id}`}> Edit Address</Link>)
                            ...
                            }
                            {
                                ...
                                <form class="contact-form mt-2 " onSubmit={handlefooterAddress}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-delay=".8s"> Add Office Address</button>
                                        </div>
                                    </div>
