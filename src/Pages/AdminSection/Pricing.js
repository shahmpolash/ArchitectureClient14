                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <h2 className=''>Edit Your Pricing Package</h2>

                                {/* <form class="contact-form mt-2 " onSubmit={handlePricing}>
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-delay=".8s"> Add Package</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="pricingTable">
                                        ...
                                        <div class="pricingTable-signup">
                                            <Link to={`/package-edit/${pri._id}`} className='theme-btn'>Edit Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
