                                    ...
                                    <>
                                        {
                                            ...
                                            action.map(c =>
                                                <Link className='theme-btn' to={`/edit-call/${c._id}`}> Edit Call To Action</Link>)
                                    ...
                                    <form class="contact-form mt-2 " onSubmit={handleActionSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn mb-3">
                                                <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s">Add Call To Action</button>
                                            </div>
                                        </div>
