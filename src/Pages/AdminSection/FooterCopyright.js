                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                                ...
                                <>
                                    {
                                        footercopyright.map(c =>
                                            footercopyright.map(c =>
                                                <Link className='theme-btn' to={`/edit-copyright/${c._id}`}> Please Edit About Footer</Link>)
                            ...
                            }
                            {
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleFooterCopyright}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Update Footer Copyright</button>
                                        </div>
                                    </div>
