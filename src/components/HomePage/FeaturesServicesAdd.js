                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <h3 className='mt-5'> Update Features Services Text </h3>
                                {
                                    ...
                                    <>
                                        {featurestext.map(text =>
                                            <Link className='theme-btn' to={`/featurestext-edit/${text._id}`}> Update Now</Link>
                                        )}
                                    </>
                                }

                                {featurestext.length === 0 &&
                                    <form class="contact-form mt-2 " onSubmit={handleFeaturesTextSection}>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="slider-btn">
                                                <button className="theme-btn" data-animation="fadeInRight" data-delay=".8s"> Add Features Text </button>
                                            </div>
                                        </div>
                                ...
                                <form class="contact-form mt-2 " onSubmit={handleItemSection}>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="contact-field p-relative c-name mb-20">
                                        ...
                                        <div class="slider-btn">
                                            <button className="theme-btn" data-delay=".8s"> Add Features Item</button>
                                        </div>
                                    </div>
                                ...
                                featureitems.map(s => <div className="col-md-6 col-lg-4">
                                    <div className="feature-card wow fadeInUp">
                                        ...
                                        <div className="feature-card_content">
                                            ...
                                            <Link to={`/edit-feature-items/${s._id}`}><h3 className="box-title" className="theme-btn">Edit Now</h3></Link>
